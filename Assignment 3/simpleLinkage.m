function ClusterSymmetryNew = simpleLinkage(ClusterMatrix, ClusterSize, rowNumber, columnNumber, ClusterSymmetry, increaseSize)
	...
	%for ii = 1:ClusterSize(i)
		...
		for j = i+1:nCluster
			...
			for jj = 1:ClusterSize(j)
				...
				if(symmetry<minDistance)
					minDistance = symmetry;
					ClusterSymmetryNew(i,j) = symmetry;
					ClusterSymmetryNew(j,i) = symmetry;
				end
			end
